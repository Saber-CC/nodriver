...
class ClientSecurityState:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ClientSecurityState:
        return cls(
            ...
            private_network_request_policy=PrivateNetworkRequestPolicy.from_json(json.get('privateNetworkRequestPolicy', json.get('localNetworkAccessRequestPolicy', 'Allow'))),
        )
